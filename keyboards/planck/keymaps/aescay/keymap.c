...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    QWERTY, XXXXXXX, XXXXXXX, TO(_WINDOW), XXXXXXX, TD(TD_CAPS), KC_SPC, OSL(_SYMBOLS), TO(_NUMBERS), XXXXXXX, XXXXXXX, XXXXXXX 
),
...
[_MOVE] = LAYOUT_planck_grid(
    ...
    _______, XXXXXXX, KC_BTN2, KC_WH_U, KC_WH_D, LSFT(KC_LALT), KC_BTN1, KC_ACL0, KC_ACL1, KC_ACL2, XXXXXXX, _______,
    XXXXXXX, XXXXXXX, XXXXXXX, LSFT(KC_LCTL), TO(_QWERTY), _______, KC_LGUI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_SYMBOLS] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TO(_QWERTY), XXXXXXX, XXXXXXX, TO(_MOVE), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_NUMBERS] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TO(_QWERTY), XXXXXXX, XXXXXXX, KC_0, KC_DOT, XXXXXXX, XXXXXXX, XXXXXXX
),
